...
if __name__ == '__main__':
    ...
    # result_metrics(G, communities, time_length)
    ...
    execution_time = (time.time() - start_time)
    time_length = '{0:.2f} s'.format(execution_time)
    result_metrics(G, communities, time_length, 'CPM')
    ...
    execution_time = (time.time() - start_time)
    time_length = '{0:.2f} s'.format(execution_time)
    result_metrics(G, communities, time_length, 'LPA')
    ...
    execution_time = (time.time() - start_time)
    time_length = '{0:.2f} s'.format(execution_time)
    result_metrics(G, communities, time_length, 'Louvain')
